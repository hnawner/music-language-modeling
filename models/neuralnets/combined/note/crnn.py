...
class CRNN:
    ...
    def __init__(self, train, test, model_type, trans = True):
        ...
        self.start = 12 # dependent on window sizes of CNN
        self.save_folder = "crnn_"+str(model_type)+"/best.ckpt"
    ...
    def build(self):
        ...
        if self.model_type == "combine":
            ...
            outs_p, _ = tf.nn.dynamic_rnn(multi_p, network_p, 
            ...
            outs_r, _ = tf.nn.dynamic_rnn(multi_r, network_r, 
