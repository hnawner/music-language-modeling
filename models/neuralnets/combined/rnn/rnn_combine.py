...
combined = tf.concat([X_p, X_r], axis = 2)
...
with tf.Session() as s:
    ...
    for e in range(n_epochs):
        ...
        if test_loss < best_loss:
            best_loss = test_loss
            save_path = saver.save(s, "rnn_comb_save/rnn_combined_best.ckpt")
...
with tf.Session() as s:
        saver.restore(s, "rnn_comb_save/rnn_combined_best.ckpt")
