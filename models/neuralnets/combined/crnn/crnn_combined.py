...
(X_tr_r, X_te_r, y_tr_r, y_te_r, X_tr_p, X_te_p, y_tr_p, y_te_p), (p_max, p_min) = \
        crnn_utils.setup_rnn(train_path, start, trans)
    ...
    for e in range(n_epochs):
        ...
        if test_loss < best_loss:
            ...
            save_path = saver.save(s, 
                    "crnn_comb_save/crnn_combined_best.ckpt")
...
with tf.Session() as s:
        saver.restore(s, "crnn_comb_save/crnn_combined_best.ckpt")
